...
| `origin/main` HEAD | `1bef293e` (PR54 merge) |
...
| 5 | **CR-B TB lag.** Design **landed** at freeze `1ed4d350` (`rtl/` only; ports `{src}_{dst}_{meaning}`). PR51 `777865f0` is merge-trace only. TB rename **landed** (PR54). New consecutive-green series is at **1/3**: [`reports/regress/2026-09-08-crb-1of3.md`](../reports/regress/2026-09-08-crb-1of3.md) — **124/124**, LINE **708/737 = 96.1%**, functional **159/159**, **0 fail**. Old consecutive greens **3/3** (2026-09-03 run1/2/3 vs `32a7f5e0`) remain **VOID**. This is **not** 4/3 and **not** nightly health. Chat PASS does **not** count. Remaining work is consecutive greens **2/3** and **3/3**. | Verification + 芯片开发PM | **OPEN** — 1/3 started. Remaining **2/3** + **3/3**. SPEC-0.2 naming frozen (PR50). Xia CHANGELOG/SPEC pin **done** (PR52, freeze `1ed4d350`). Record: [`docs/cr/CR-IFACE-RENAME-B-2026-09-08.md`](cr/CR-IFACE-RENAME-B-2026-09-08.md). |
...
| **G** | **Interface naming.** **DECIDED 2026-09-08 (Asia/Shanghai): Option B.** Formal CR + full rename to `{src}_{dst}_{meaning}` (`dll` not `dl`). SPEC-0.2 naming **frozen** (PR50). Design **landed** (freeze `1ed4d350`; PR51 merge `777865f0` is trace only). Xia CHANGELOG/SPEC pin **done** (PR52). TB rename **landed** (PR54). New series at **1/3**; remaining **2/3** and **3/3**. No functional width/protocol change. F1 (`ovf_l`) still stands — no ECO. | Not blocked on the decision. **Blocked on Verification 2/3 + 3/3.** Inventory: [`docs/cr/CR-IFACE-NAMING-DRAFT-2026-09-08.md`](cr/CR-IFACE-NAMING-DRAFT-2026-09-08.md). Record: [`docs/cr/CR-IFACE-RENAME-B-2026-09-08.md`](cr/CR-IFACE-RENAME-B-2026-09-08.md). | **Decided: B.** Design + Xia pin + TB rename + 1/3 done. Remaining: consecutive greens **2/3** and **3/3** vs DUT freeze `1ed4d350`; chat PASS does not count; not nightly / not 4/3. Path B still **NOT PASS**. |
...
- No coverage / LINE / TP numbers beyond the committed 1/3 report ([`reports/regress/2026-09-08-crb-1of3.md`](../reports/regress/2026-09-08-crb-1of3.md): **124/124**, LINE **708/737 = 96.1%**, functional **159/159**, **0 fail**).
- Old consecutive greens **3/3** (2026-09-03 vs `32a7f5e0`) are **VOID**. Do not count them. Do not count chat PASS. Do not count nightly health as 4/3 or as 2/3 / 3/3.
- CR-B Option B **RTL has landed** at freeze `1ed4d350`. TB rename **has landed** (PR54). New series is **1/3**, not a new 3/3. This file does **not** claim signoff.
