...
| TP-PHY-006 | `tc_phy_flit_20b` | Flit 20 字节，不得把 640b 当 flit |
| TP-PHY-007 | `tc_phy_pma_pcs_boundary` | txdata/rxdata[511:0] @922MHz 无额外握手 |
| TP-PHY-008 | `tc_phy_nw_dll_640b` | NW↔DLL 640b @1.25GHz |
| TP-PHY-009 | `tc_phy_tx_fec_1024_two_beats` | FEC 1024b = 两拍 512 |
| TP-PHY-010 | `tc_phy_tx_4x160_afifo_4x128` | 4×160 AFIFO → 4×128=512 |
| TP-PHY-011 | `tc_phy_tx_backpressure_chain` | TX 可逐级向 NW 反压 |
| TP-PHY-012 | `tc_phy_rx_inverse_chain` | RX 为 TX 逆过程 |
...
| TP-CRD-004 | `tc_crd_1024_flit_bp` | pending≥1024 flit → 反压 NW + Crd_Ack |
...
| TP-HOLE-G7 | `tc_hole_g7_closed_flit` | G7 已关闭：1024 单位是 flit |
