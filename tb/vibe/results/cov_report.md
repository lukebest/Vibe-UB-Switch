...
| `vibe_dll_credit.sv` | 15/16 | 93.8 | 94/105 | 89.5 |
...
| `vibe_dll_rx.sv` | 17/18 | 94.4 | 25/536 | 4.7 |
| `vibe_dll_sm.sv` | 15/16 | 93.8 | 13/13 | 100.0 |
| `vibe_dll_tx.sv` | 16/16 | 100.0 | 80/551 | 14.5 |
| `vibe_ebch16.sv` | 33/33 | 100.0 | 21/21 | 100.0 |
| `vibe_fabric.sv` | 26/27 | 96.3 | 149/712 | 20.9 |
...
| `vibe_lmsm.sv` | 57/72 | 79.2 | 63/65 | 96.9 |
...
| `vibe_pcs_tx_fec.sv` | 28/29 | 96.6 | 126/191 | 66.0 |
...
| `vibe_saf_ing.sv` | 15/15 | 100.0 | 43/85 | 50.6 |
...
| **TOTAL implemented vibe_*** | **618/638** | **96.9** | **7917/19807** | **40.0** |

## Uncovered LINE points

- `line /workspace/rtl/dll/vibe_dll_credit.sv:56 if`
- `line /workspace/rtl/dll/vibe_dll_rx.sv:61 if`
- `line /workspace/rtl/dll/vibe_dll_sm.sv:36 else`
- `line /workspace/rtl/fabric/vibe_fabric.sv:185 if`
...
- `line /workspace/rtl/lmsm/vibe_lmsm.sv:56 elsif`
- `line /workspace/rtl/lmsm/vibe_lmsm.sv:58 if`
- `line /workspace/rtl/lmsm/vibe_lmsm.sv:58 else`
- `line /workspace/rtl/lmsm/vibe_lmsm.sv:70 elsif`
- `line /workspace/rtl/lmsm/vibe_lmsm.sv:75 else`
- `line /workspace/rtl/lmsm/vibe_lmsm.sv:85 elsif`
- `line /workspace/rtl/lmsm/vibe_lmsm.sv:86 else`
- `line /workspace/rtl/pcs/vibe_pcs_tx_fec.sv:96 else`
...
- … 11850 more (see annotate/ and cov_raw.txt)
