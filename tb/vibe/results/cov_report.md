...
| `vibe_dll_rx.sv` | 19/22 | 86.4 | 33/604 | 5.5 |
| `vibe_dll_sm.sv` | 14/14 | 100.0 | 13/13 | 100.0 |
| `vibe_dll_tx.sv` | 40/51 | 78.4 | 177/1873 | 9.5 |
| `vibe_ebch16.sv` | 33/33 | 100.0 | 21/21 | 100.0 |
| `vibe_fabric.sv` | 46/48 | 95.8 | 143/732 | 19.5 |
...
| `vibe_pcs_rx_amctl_lock.sv` | 18/22 | 81.8 | 139/472 | 29.4 |
| `vibe_pcs_rx_deskew.sv` | 12/12 | 100.0 | 50/1312 | 3.8 |
| `vibe_pcs_scramble.sv` | 13/13 | 100.0 | 470/511 | 92.0 |
| `vibe_pcs_tx.sv` | 0/0 | 0.0 | 1798/1941 | 92.6 |
| `vibe_pcs_tx_amctl.sv` | 5/5 | 100.0 | 152/152 | 100.0 |
| `vibe_pcs_tx_cw2beat.sv` | 9/9 | 100.0 | 8/8 | 100.0 |
| `vibe_pcs_tx_fec.sv` | 24/24 | 100.0 | 132/175 | 75.4 |
| `vibe_pcs_tx_g1.sv` | 15/17 | 88.2 | 11/12 | 91.7 |
| `vibe_pcs_tx_pack.sv` | 17/17 | 100.0 | 537/680 | 79.0 |
| `vibe_pma_bnd.sv` | 5/5 | 100.0 | 43/1028 | 4.2 |
| `vibe_port_sel.sv` | 17/17 | 100.0 | 49/139 | 35.3 |
| `vibe_route_lu.sv` | 10/10 | 100.0 | 24/76 | 31.6 |
| `vibe_rs128_120_dec.sv` | 13/13 | 100.0 | 14/152 | 9.2 |
| `vibe_rs128_120_enc.sv` | 8/8 | 100.0 | 117/159 | 73.6 |
...
| **TOTAL implemented vibe_*** | **621/651** | **95.4** | **4992/14508** | **34.4** |
...
- `line /workspace/rtl/dll/vibe_dll_rx.sv:100 if`
- `line /workspace/rtl/dll/vibe_dll_rx.sv:118 else`
- `line /workspace/rtl/dll/vibe_dll_rx.sv:128 if`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:144 else`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:145 if`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:146 if`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:147 if`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:150 else`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:151 if`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:155 if`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:159 if`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:208 else`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:94 else`
- `line /workspace/rtl/dll/vibe_dll_tx.sv:98 if`
- `line /workspace/rtl/fabric/vibe_fabric.sv:246 if`
- `line /workspace/rtl/fabric/vibe_fabric.sv:248 if`
...
- `line /workspace/rtl/pcs/vibe_pcs_rx_amctl_lock.sv:55 elsif`
- `line /workspace/rtl/pcs/vibe_pcs_rx_amctl_lock.sv:56 elsif`
- `line /workspace/rtl/pcs/vibe_pcs_rx_amctl_lock.sv:57 elsif`
- `line /workspace/rtl/pcs/vibe_pcs_rx_amctl_lock.sv:58 if`
- `line /workspace/rtl/pcs/vibe_pcs_tx_g1.sv:51 else`
- `line /workspace/rtl/pcs/vibe_pcs_tx_g1.sv:65 elsif`
...
- … 9476 more (see annotate/ and cov_raw.txt)
