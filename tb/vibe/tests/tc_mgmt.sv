...
module tc_mgmt;
  ...
  logic [3:0] default_bm, port_rst, lmsm_go, fab_mgmt_cfg6_hit, mgmt_fab_cfg6_consume, mgmt_nw_vld, mgmt_nw_ready;
  ...
  vibe_mgmt u_m (
    ...
    .mgmt_fab_cfg6_consume(mgmt_fab_cfg6_consume), .mgmt_nw_data(mgmt_nw_data), .mgmt_nw_vld(mgmt_nw_vld),
  ...
  initial begin
    ...
    fab_mgmt_cfg6_hit = 0; mgmt_nw_ready = 4'b1111;
    ...
    if (!mgmt_fab_cfg6_consume[0]) begin
      $display("FAIL tc_mgmt");
