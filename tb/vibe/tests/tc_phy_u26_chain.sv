...
module tc_phy_u26_chain;
  ...
  initial begin
    ...
    t0 = 0; t1 = 0; t2 = 0; t3 = 0; tvl = 0; pma_pcs_rxdata = 0;
    ...
    if (pcs_pma_txdata[127:0] !== 128'h11 || r0 !== 128'h11) begin
      $display("FAIL tc_phy_u26_chain");
      $display("  stimulus : PMA lanes 11/22/33/44 looped pma_pcs_rxdata=pcs_pma_txdata");
      $display("  expected : [127:0]=lane0=11 both TX pack and RX slice");
      $display("  actual   : pcs_pma_txdata[127:0]=%h r0=%h", pcs_pma_txdata[127:0], r0);
      $display("  hier     : u_p.pcs_pma_txdata / u_p.pma_afifo_lane0");
      fail = 1;
    end
    sent = 0;
    while (sent < 5) begin
