...
| 6 | `tc_nw_pkt_pma_loopback` (unit) | TP-PHY-012: recover LPH on NW `data[511:0]` after PMA loopback. PNG/VCD are historical (640 NW). vs `d6549521`: **FAIL** width 512 vs 640 | [`nw_pkt_pma_loopback.png`](nw_pkt_pma_loopback.png) | [`nw_pkt_pma_loopback.vcd`](nw_pkt_pma_loopback.vcd) | `FAIL tc_nw_pkt_pma_loopback` (this SHA) |
