...
UNIT_MORE = [
    ...
    ("tc_vibe_pcs_rx_unpack", "vibe_pcs_rx_unpack_cocotb_top",
     ...
     "entry_unit"),
    ("tc_vibe_pcs_tx_pack", "vibe_pcs_tx_pack_cocotb_top",
     [_wrap("vibe_pcs_tx_pack_cocotb_top"),
      _w("pcs", "vibe_pcs_tx_pack.sv"),
      _w("pcs", "vibe_pcs_tx_amctl.sv"),
      _w("pcs", "vibe_ebch16.sv")],
     "entry_unit"),
    ("tc_vibe_pcs_tx_fec", "vibe_pcs_tx_fec_cocotb_top",
     [_wrap("vibe_pcs_tx_fec_cocotb_top"),
      _w("pcs", "vibe_pcs_tx_fec.sv"),
      _w("pcs", "vibe_rs128_120_enc.sv")],
     "entry_unit"),
    ("tc_vibe_pcs_rx_fec", "vibe_pcs_rx_fec_cocotb_top",
     [_wrap("vibe_pcs_rx_fec_cocotb_top"),
      _no_input_default("pcs", "vibe_pcs_rx_fec.sv")],
     "entry_unit"),
    ("tc_vibe_pcs_tx_g1", "vibe_pcs_tx_g1_cocotb_top",
     [_wrap("vibe_pcs_tx_g1_cocotb_top"),
      _w("pcs", "vibe_pcs_tx_g1.sv")],
     "entry_unit"),
    ("tc_vibe_bcrc", "vibe_bcrc_cocotb_top",
     [_wrap("vibe_bcrc_cocotb_top"),
      _w("dll", "vibe_bcrc.sv")],
     "entry_unit"),
    ("tc_vibe_dll_credit", "vibe_dll_credit_cocotb_top",
     [_wrap("vibe_dll_credit_cocotb_top"),
      _w("dll", "vibe_dll_credit.sv")],
     "entry_unit"),
    ("tc_vibe_dll_sm", "vibe_dll_sm_cocotb_top",
     [_wrap("vibe_dll_sm_cocotb_top"),
      _w("dll", "vibe_dll_sm.sv")],
     "entry_unit"),
