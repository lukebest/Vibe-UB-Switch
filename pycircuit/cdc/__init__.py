"""CDC leaves (``rtl/cdc``). Stage-1: ``vibe_afifo``. Stage-3: ``vibe_sync2``. Stage-4: ``vibe_rst_sync``. Stage-5: ``vibe_gear_128_160``."""
...
__all__ = ["build", "vibe_afifo", "vibe_sync2", "vibe_rst_sync", "vibe_gear_128_160"]
