"""Emit the product SystemVerilog for vibe_dll_retry_req_sm (hand-finished).

Keeps tip ports, async-low ``rst_n``, NORMAL / REQ (1 Idle +
...
// Regenerate: make -C pycircuit vibe_dll_retry_req_sm
"""
...
def main() -> int:
    ...
    dest = repo / "rtl" / "dll" / "vibe_dll_retry_req_sm.sv"
    write_rtl(dest)
    print(f"wrote {dest}")
    return 0
