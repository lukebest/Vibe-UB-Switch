...
+ `vibe_pcs_tx_pack` + `vibe_pcs_tx_fec` + `vibe_pcs_rx_fec`
...
+ `vibe_port_sel` + `vibe_voq_egr` + `vibe_saf_ing`). SPEC semantics
...
make -C pycircuit vibe_pma_bnd       # lands rtl/pma/vibe_pma_bnd.sv
...
make -C pycircuit vibe_pcs_scramble  # lands rtl/pcs/vibe_pcs_scramble.sv
...
make -C pycircuit vibe_rs128_120_dec # lands rtl/pcs/vibe_rs128_120_dec.sv
make -C pycircuit vibe_pcs_rx_deskew # lands rtl/pcs/vibe_pcs_rx_deskew.sv
make -C pycircuit vibe_pcs_rx_amctl_lock # lands rtl/pcs/vibe_pcs_rx_amctl_lock.sv
...
make -C pycircuit vibe_pcs_tx_g1    # lands rtl/pcs/vibe_pcs_tx_g1.sv
make -C pycircuit vibe_bcrc         # lands rtl/dll/vibe_bcrc.sv
make -C pycircuit vibe_dll_credit   # lands rtl/dll/vibe_dll_credit.sv
make -C pycircuit vibe_dll_sm       # lands rtl/dll/vibe_dll_sm.sv
make -C pycircuit vibe_dll_rx       # lands rtl/dll/vibe_dll_rx.sv
make -C pycircuit vibe_dll_retry_ack_sm # lands rtl/dll/vibe_dll_retry_ack_sm.sv
...
make -C pycircuit vibe_port_sel      # lands rtl/fabric/vibe_port_sel.sv
make -C pycircuit vibe_voq_egr       # lands rtl/fabric/vibe_voq_egr.sv
